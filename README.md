...
-- Screen reader optimised: It uses the [accessible-output2][https://github.com/accessibleapps/accessible_output2] module to speak and braille the status messages;
...
```
to run the program.
**If you wish to build an executable, you can use [pyinstaller][https://pyinstaller.org/en/stable/] or any other similar module**.
```bash:
